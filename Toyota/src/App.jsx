    ...
    <section className='h-screen bg-red-500 flex items-center justify-center'>
      <main className='w-150 h-150 bg-neutral-950 shadow-xl/30 rounded-2xl'>
        ...
        <footer className='w-full flex items-center justify-center'>
          <h2 className="text-white font-extralight">Não possui uma conta?</h2><Link to="cadatro" className="text-red-500 font-bold mx-1 hover:text-red-700 transition duration-200">Cadastre-se</Link>
        </footer>
      </main>
    </section>
  )
